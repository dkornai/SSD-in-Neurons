...
#### GENERAL RING MODEL FOR ####

gill_ring = ctypes.cdll.LoadLibrary("./gill_ring.so")
_gill_ring_loop = gill_ring.gillespie_ring_loop
...
'''
# argument types set according to c function
_gill_ring_loop.argtypes = [f8, f8, f8, f8, i8, np_arr_flt, i8, np_arr_int, _2dp] 
_gill_ring_loop.restype  = None # no return, the function modifies the output array in-place
